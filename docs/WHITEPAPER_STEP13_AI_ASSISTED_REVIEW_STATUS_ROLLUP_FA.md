...
| Step 13 reviewer README | ساخته شده؛ reviewer-orientation / no signoff |
...
| `docs/WHITEPAPER_STEP13_README_FA.md` | `7b145f33a2b107861a4ef3573f382aafdf92d5ee` | راهنمای ترتیب خواندن و وضعیت اعتبار reviewها | reviewer-orientation / no signoff |
...
| `docs/WHITEPAPER_STEP13_AI_ASSISTED_REVIEW_STATUS_ROLLUP_FA.md` | `502e51cd6627b87f076089a8f472e3071b0213af` | رول‌آپ وضعیت AI-assisted review | status-rollup-only / no signoff |

## ۴. تمایز حیاتی اضافه‌شده

اکنون این قاعده canonical ثبت شده است:
...
## ۵. canonical-source check برای reviewهای آینده
...
۱. در صورت نیاز، به‌روزرسانی مستقیم فایل‌های prompt/bundle/template با متن patch canonical review input.  
۲. آماده‌سازی bundle آینده شامل سپیدنامه، منشور، FAQ/کیت‌های مرتبط، اسناد Step 13 و issue context.  
۳. اجرای review جدید فقط با canonical-source check اجباری.  
