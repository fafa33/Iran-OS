...
| G-11 | مانیفست استقرار | **تکمیل جزئی (docs — دامنه ۱۶ از ۲۵ قرارداد)** |
...
**نوع رفع:** مستندسازی — **PARTIALLY ADDRESSED (دامنه ۱۶ از ۲۵ قرارداد)**  
...
**باقی‌مانده مستندی:** ۹ قرارداد (VotingSystem، Parliament، BudgetAllocation، Fargard7PolicyAdapter، VelocityFee، BaseIncome، HealthCoverage، DisabilitySupport، SovereignCrawler) خارج از دامنه این نسخه مانیفست‌اند؛ مانیفست کامل ۲۵ قراردادی کار مستندی آینده است.
