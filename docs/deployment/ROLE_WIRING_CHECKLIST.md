...
- [ ] اسکریپت‌های `deploy/` برای قراردادهای هدف این استقرار وجود دارند — برای ۱۱ قرارداد (۶ قرارداد مسیر اصلی پولی/پشتوانه + ۵ قرارداد Layer 1 وابسته صرفاً به Kernel) در مخزن پیاده‌سازی شده‌اند (`deploy/README.md`)؛ برای ۱۴ قرارداد باقی‌مانده هنوز ایجاد نشده‌اند (باقی‌مانده G-11 فنی)
