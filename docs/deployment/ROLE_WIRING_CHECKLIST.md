...
**به‌روزرسانی وضعیت اسکریپت‌های deploy/ (۱۲/۲۵ قرارداد پیاده‌سازی شد — افزودن PriceOracle):** ۱۶ تیر ۲۵۸۵ شاهنشاهی / ۷ ژوئیه ۲۰۲۶ میلادی  
...
- [ ] اسکریپت‌های `deploy/` برای قراردادهای هدف این استقرار وجود دارند — برای ۱۲ قرارداد (۶ قرارداد مسیر اصلی پولی/پشتوانه + ۶ قرارداد Layer 1) در مخزن پیاده‌سازی شده‌اند (`deploy/README.md`)؛ برای ۱۳ قرارداد باقی‌مانده هنوز ایجاد نشده‌اند (باقی‌مانده G-11 فنی)
