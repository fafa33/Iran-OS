...
- راهنمای فارسی بازبینی و ثبت نظر درباره نگاشت سپیدنامه به سیستم: [step13/WHITEPAPER_STEP13_REVIEW_GUIDE_FA.md](step13/WHITEPAPER_STEP13_REVIEW_GUIDE_FA.md)
- جدول اتصال workstreamهای گام ۱۳ به issueهای #12 تا #19: [step13/WHITEPAPER_STEP13_ISSUE_LINKAGE_FA.md](step13/WHITEPAPER_STEP13_ISSUE_LINKAGE_FA.md)
- رجیستر شکاف‌های گام ۱۳: [step13/WHITEPAPER_STEP13_GAP_REGISTER_FA.md](step13/WHITEPAPER_STEP13_GAP_REGISTER_FA.md)
- معیارهای آینده برای بررسی بسته‌شدن گام ۱۳: [step13/WHITEPAPER_STEP13_CLOSURE_CRITERIA_FA.md](step13/WHITEPAPER_STEP13_CLOSURE_CRITERIA_FA.md)
- تحویل فنی گام ۱۳ برای اوراکل‌ها، نگهداشت کلید و چندامضایی: [step13/WHITEPAPER_STEP13_ORACLE_CUSTODY_HANDOFF_FA.md](step13/WHITEPAPER_STEP13_ORACLE_CUSTODY_HANDOFF_FA.md)
- مینی‌اسپک نگهداشت کلید و چندامضایی: [step13/WHITEPAPER_STEP13_CUSTODY_MULTISIG_MINI_SPEC_FA.md](step13/WHITEPAPER_STEP13_CUSTODY_MULTISIG_MINI_SPEC_FA.md)
- مینی‌اسپک تجمیع داده اوراکل و مرز سیگنال: [step13/WHITEPAPER_STEP13_ORACLE_AGGREGATION_MINI_SPEC_FA.md](step13/WHITEPAPER_STEP13_ORACLE_AGGREGATION_MINI_SPEC_FA.md)
- چک‌لیست شواهد گام ۱۳ برای نگهداشت کلید و چندامضایی: [step13/WHITEPAPER_STEP13_CUSTODY_EVIDENCE_CHECKLIST_FA.md](step13/WHITEPAPER_STEP13_CUSTODY_EVIDENCE_CHECKLIST_FA.md)
- چک‌لیست شواهد گام ۱۳ برای اوراکل‌ها و تجمیع داده: [step13/WHITEPAPER_STEP13_ORACLE_EVIDENCE_CHECKLIST_FA.md](step13/WHITEPAPER_STEP13_ORACLE_EVIDENCE_CHECKLIST_FA.md)
- جمع‌بندی ردیابی گام ۱۳ برای اوراکل، نگهداشت کلید و چندامضایی: [step13/WHITEPAPER_STEP13_ORACLE_CUSTODY_TRACEABILITY_ROLLUP_FA.md](step13/WHITEPAPER_STEP13_ORACLE_CUSTODY_TRACEABILITY_ROLLUP_FA.md)
- قالب ثبت evidence آینده برای گام ۱۳ و گام ۱۲: [step13/WHITEPAPER_STEP13_FUTURE_EVIDENCE_SUBMISSION_TEMPLATE_FA.md](step13/WHITEPAPER_STEP13_FUTURE_EVIDENCE_SUBMISSION_TEMPLATE_FA.md)
- جمع‌بندی گردش‌کار evidence آینده در گام ۱۳ و گام ۱۲: [step13/WHITEPAPER_STEP13_EVIDENCE_WORKFLOW_ROLLUP_FA.md](step13/WHITEPAPER_STEP13_EVIDENCE_WORKFLOW_ROLLUP_FA.md)
- قالب درخواست review برای گام ۱۳ و گام ۱۲: [step13/WHITEPAPER_STEP13_REVIEW_REQUEST_TEMPLATE_FA.md](step13/WHITEPAPER_STEP13_REVIEW_REQUEST_TEMPLATE_FA.md)
- جمع‌بندی گردش‌کار درخواست review در گام ۱۳ و گام ۱۲: [step13/WHITEPAPER_STEP13_REVIEW_REQUEST_WORKFLOW_ROLLUP_FA.md](step13/WHITEPAPER_STEP13_REVIEW_REQUEST_WORKFLOW_ROLLUP_FA.md)
- چک‌پوینت وضعیت فعلی گام ۱۳: [step13/WHITEPAPER_STEP13_CURRENT_STATUS_CHECKPOINT_FA.md](step13/WHITEPAPER_STEP13_CURRENT_STATUS_CHECKPOINT_FA.md) — به‌روزرسانی پس از CLC-06 و DOC-01/DOC-02 (main: `66e8cdf`، ۴۹۹ test passing)
- جمع‌بندی وضعیت درخواست‌های review گام ۱۳ برای issueهای گام ۱۲: [step13/WHITEPAPER_STEP13_REVIEW_REQUEST_STATUS_ROLLUP_FA.md](step13/WHITEPAPER_STEP13_REVIEW_REQUEST_STATUS_ROLLUP_FA.md)
- پروتکل مدیریت پاسخ‌های review در گام ۱۳ و گام ۱۲: [step13/WHITEPAPER_STEP13_REVIEW_RESPONSE_HANDLING_PROTOCOL_FA.md](step13/WHITEPAPER_STEP13_REVIEW_RESPONSE_HANDLING_PROTOCOL_FA.md)
