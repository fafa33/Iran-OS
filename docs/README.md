...
|[Faq-fa.md](https://github.com/fafa33/Iran-OS/blob/main/docs/Faq-fa.md)                  |سوالات متداول — پاسخ به منتقدان         |
...
|بخش                                                                                        |محتوا                                       |
|-------------------------------------------------------------------------------------------|--------------------------------------------|
|[whitepaper](https://github.com/fafa33/Iran-OS/blob/main/whitepaper/whitepaper-fa.md)      |سپیدنامه فنی کامل — معماری اجرایی سیستم     |
|[constitution](https://github.com/fafa33/Iran-OS/blob/main/constitution/constitution-fa.md)|منشور رفاه و عدالت — پیمان ملی مشروطه سکولار|
